...
Point(7) = {(b1+b2)-b9+h1+0.2+0.25*(hL)*Cos(angle_wn), 0, 0, clen};
...
circ_rad = (b1+b2+b3+b4+b5) - p5[0]; 
//Point(15) = {p5[0]+circ_rad/Sqrt(2), p5[1]+circ_rad/Sqrt(2), 0, clen};

Point(16) = {p5[0], (h1+h2+h3), 0, clen};
Point(17) = {p2[0], (h1+h2+h3), 0, clen};
...
// ----- Point 24 ------
p15[] = Point{15};
p1[] = Point{15}; // start line 1
p2[] = {p15[0]+10., p15[1], 0}; // end line 1
...
p15[] = Point{15};
p27[] = Point{27};
Point(40) = {p27[0], p15[1], 0, clen};
Point(41) = {(b1+b2+b3+b4+b5+b6+b7+b8), p15[1], 0, clen};
...
p3[] = Point{1}; // center of circle
Call calc_intersection_line_circle;
Point(42) = {inter1_x, p15[1], inter1_y, clen}; // now y corresponds to z coordinate
//
//// ------- Point 43 -----
p41[] = Point{41};
circ_rad = p41[0];
...
p3[] = Point{1}; // center of circle
Call calc_intersection_line_circle;
Point(43) = {inter1_x, p15[1], inter1_y, clen}; // now y corresponds to z coordinate

Point(205) = {0, p15[1], 0, clen}; // additional for rotation of curve
