...
//p_233[] = Translate {0, p12[1], 0} { Duplicata{ Point{33}; } };
//p_bezier2[] = Rotate {{0, 1, 0}, {0, 0, 0}, -Pi/4} { Duplicata { Point{111, 1032, 1031}; } };
//
//Circle(2351) = {12, 203, p_232[0]};
//Circle(2354) = {11, 13, p_233[0]};
//
...
//p_333[] = Translate {0, p17[1], 0} { Duplicata{ Point{33}; } };
//p_bezier3[] = Rotate {{0, 1, 0}, {0, 0, 0}, -Pi/4} { Duplicata { Point{116, 1012, 1011}; } };
//
//Circle(3351) = {17, 203, p_332[0]};
//Circle(3354) = {16, 13, p_333[0]};
//
